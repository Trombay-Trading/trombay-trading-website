                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                    ...
                    >
                        ...
                        <h3 className="font-serif text-4xl md:text-5xl text-brand-900 leading-tight mb-6">
                            End-to-End Merchant <br /><span className="font-medium">Exporting Solutions.</span>
                        </h3>
                    </motion.div>

                    {/* Removed text block for cleaner layout */}
                </div>
                            ...
                            >
                                ...
                                <div className="flex gap-6 relative z-10">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-brand-600 font-medium text-sm md:text-base leading-relaxed">
                                            {service.desc}
                                        </p>
                                    </div>
                                </div>
