            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    >
                        ...
                        <h3 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight">
                            Connecting India to the <span className="italic font-light text-brand-300">Global Market.</span>
                        </h3>
                        <p className="text-brand-200 text-lg font-light leading-relaxed max-w-2xl mx-auto">
                    ...
                    {clients.map((client, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                key={idx}
                                className="group bg-brand-900 border border-brand-800 p-8 hover:bg-brand-800/80 transition-all duration-500 flex flex-col h-full"
                            >
                                <div className="mb-6 mb-auto">
                                    <div className="w-12 h-12 rounded-full border border-brand-600 flex items-center justify-center text-brand-300 group-hover:scale-110 transition-transform duration-500 bg-brand-950">
                                        <Icon className="w-5 h-5" strokeWidth={1.5} />
                                    </div>
                                </div>
                                <div>
                                    <h4 className="font-serif text-xl text-brand-50 mb-3">{client.title}</h4>
                                    <p className="text-brand-300 font-light text-sm leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                                        {client.desc}
                                    </p>
                                </div>
                            </motion.div>
                ...
                <div className="text-center">
                    ...
                    >
                        <Link
                            href="#inquiry"
                            className="inline-flex items-center gap-3 text-brand-50 border border-brand-600 px-8 py-4 hover:bg-brand-50 hover:text-brand-950 text-xs uppercase tracking-widest transition-all duration-300 group"
                        >
